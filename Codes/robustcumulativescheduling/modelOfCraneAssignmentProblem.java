...
public class modelOfCraneAssignmentProblem {
    ...
    public modelOfCraneAssignmentProblem(int nA, int nC, int nR, int min_processingTime, int max_processingTime, int mode1, int mode2, long seedValue, int heuristic, boolean filterLowerBound, boolean filterUpperBound, boolean activateImprovingDetectionLowerBound, boolean findAllOptimalSolutions, boolean printSolutionInformatioin, int r) throws UnsupportedEncodingException, FileNotFoundException {
...
//The constraint implies that if i and j overlap, but s_i starts first and ends after 
        ...
        //  LNSFactory.rlns(m, startingTimes, 30, 20140909L, new FailCounter(100));
